...
class _MyCartState extends State<MyCart> {
  ...
  Widget build(BuildContext context) {
    ...
    return (cartArticles.length==0)? Center(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          setState(() {
                                            ...
                                            sums[position] = cartitems[position].quatity *
                                                cartitems[position].price;
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        cartitems[position].quatity.toString(),
                                        style: TextStyle(
                                            fontSize: 15,
                                            fontFamily: Roboto.bold),
                                      ),
                                    ...
                                    Container(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          setState(() {
                                            if (cartitems[position].quatity != 1) {
                                              cartitems[position].quatity--;
                                              sums[position] = cartitems[position].quatity *
                                                  cartitems[position].price;
                                            }
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Container(
                                      child: Text(
                                        cartitems[position].price.toString() +
                                            '\$',
                  ...
                  itemBuilder: (context, position) {
                    return Row(
                      children: <Widget>[
                        Container(
                          width: screenWidth-200,
                          child: Text(cartitems[position].title,
                            overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              fontFamily: Roboto.regular
                          ),
                        ...
                        Spacer(),
                        Text(sums[position].toStringAsFixed(2) + '\$',
                        style: TextStyle(
                            fontFamily: Roboto.regular
                        ),
                        ),
                ...
                children: <Widget>[
                  ...
                  Text(
                    (sums.length == 0)
                        ? '0\$'
                        :
                        ((sums.reduce((value, element) => value + element) -
                            couponValue)<0)? '0\$' : (sums.reduce((value, element) => value + element) -
                            couponValue)
                            .toStringAsFixed(2) +'\$',
                    style: TextStyle(
                        fontSize: 16,
